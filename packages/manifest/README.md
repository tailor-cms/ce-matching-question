...
Shared element definition for the **Matching Question** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-matching-question-manifest
```
...
```ts
import manifest, { type ElementData } from '@tailor-cms/ce-matching-question-manifest';

manifest.type;       // 'MATCHING_QUESTION'
