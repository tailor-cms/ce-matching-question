...
Server-side module for the **Matching Question** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-matching-question-server
```
...
```ts
import serverModule from '@tailor-cms/ce-matching-question-server';
```
